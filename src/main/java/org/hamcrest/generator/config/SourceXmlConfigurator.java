...
public class SourceXmlConfigurator {
    ...
    public SourceXmlConfigurator(SugarConfiguration sugarConfiguration, ClassLoader classLoader) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            SourceXmlConfigurator xmlConfigurator
                    = new SourceXmlConfigurator(sugarGenerator, SourceXmlConfigurator.class.getClassLoader());
